 ...
 */
class Classes extends \ClasseBundle\Entity\Classes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ClasseBundle\\Entity\\Classes' . "\0" . 'num', '' . "\0" . 'ClasseBundle\\Entity\\Classes' . "\0" . 'libelle', '' . "\0" . 'ClasseBundle\\Entity\\Classes' . "\0" . 'capacite'];
        }
