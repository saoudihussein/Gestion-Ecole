...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vV2WZcqMcB', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9WFRhCKRvd', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VEDoVIoO8t', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5Tj3FKjQVi', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('q8XYiT5epf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\PersonneBundle/Resources/views'), 'Personne');
        $instance->addPath(($this->targetDirs[3].'\\src\\PersonneBundle/Resources/views'), '!Personne');
        $instance->addPath(($this->targetDirs[3].'\\src\\EleveBundle/Resources/views'), 'Eleve');
        $instance->addPath(($this->targetDirs[3].'\\src\\EleveBundle/Resources/views'), '!Eleve');
        $instance->addPath(($this->targetDirs[3].'\\src\\NoteBundle/Resources/views'), 'Note');
        $instance->addPath(($this->targetDirs[3].'\\src\\NoteBundle/Resources/views'), '!Note');
        $instance->addPath(($this->targetDirs[3].'\\src\\MatiereBundle/Resources/views'), 'Matiere');
        $instance->addPath(($this->targetDirs[3].'\\src\\MatiereBundle/Resources/views'), '!Matiere');
        $instance->addPath(($this->targetDirs[3].'\\src\\ClasseBundle/Resources/views'), 'Classe');
        $instance->addPath(($this->targetDirs[3].'\\src\\ClasseBundle/Resources/views'), '!Classe');
        $instance->addPath(($this->targetDirs[3].'\\src\\MaitreBundle/Resources/views'), 'Maitre');
        $instance->addPath(($this->targetDirs[3].'\\src\\MaitreBundle/Resources/views'), '!Maitre');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'PersonneBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PersonneBundle'),
                    'namespace' => 'PersonneBundle',
                ],
                'EleveBundle' => [
                    'parent' => NULL,
                ...
                'NoteBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\NoteBundle'),
                    'namespace' => 'NoteBundle',
                ],
                'MatiereBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MatiereBundle'),
                    'namespace' => 'MatiereBundle',
                ],
                'ClasseBundle' => [
                    'parent' => NULL,
                ...
                'MaitreBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MaitreBundle'),
                    'namespace' => 'MaitreBundle',
                ],
                'DebugBundle' => [
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'PersonneBundle' => 'PersonneBundle\\PersonneBundle',
                'EleveBundle' => 'EleveBundle\\EleveBundle',
                'NoteBundle' => 'NoteBundle\\NoteBundle',
                'MatiereBundle' => 'MatiereBundle\\MatiereBundle',
                'ClasseBundle' => 'ClasseBundle\\ClasseBundle',
                'MaitreBundle' => 'MaitreBundle\\MaitreBundle',
